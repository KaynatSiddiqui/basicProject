...
$(document).ready(function() {
	...
	var dean_editmode = sessionStorage.getItem("dean_editmode");
		...
		if(questionId !=='' && questionId !== null && dean_editmode === "true" && bk === null) {
  		   ...
  		   CKEDITOR.instances.option4.setData(qdata[0].option4["value"]);
	  		 if(multiComprh.test(layout)){
	  			 var params = qdata[0].answer;
	  			  ...
	  			  if(qdata[0].answer  != null || qdata[0].answer != undefined ){
    		...
    		for(var amf=0;amf<moreFields;amf++){
				...
				CKEDITOR.instances['question'+fdcplus].setData(qdata[amf+1].question["value"]);
	  		   ...
	  		   if(multiComprh.test(layout)){
	  			 ...
	  			 if(qdata[amf+1].answer  != null || qdata[amf+1].answer != undefined ){
