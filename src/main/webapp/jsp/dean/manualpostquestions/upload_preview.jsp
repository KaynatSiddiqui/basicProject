							...
							<div class="row">
								<div class="col-md-5 col-md-offset-5">
									<div class="button-list mt-10 mb-10">
										<a id="preview_back" href="<%= AppConstants.BASE_URL %>dean/manualpostquestions/manual_post_qns.jsp" class="btn btn-back" >Back</a>
										<a id="saveBtn4" class="btn btn-save_next" href="<%= AppConstants.BASE_URL %>dean/manualpostquestions/manual_post_qns.jsp" onclick="">Save & Finish</a>
									</div>
								</div>
							</div>
