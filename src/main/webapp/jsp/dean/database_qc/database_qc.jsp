										...
										<div class="col-md-2">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker"  data-style="form-control btn-default btn-outline" onchange="getAllLayouts(this.value);" id="topic" disabled>
																											</select>
												</div>	
											</div>
											<div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker"  data-style="form-control btn-default btn-outline" onchange="getSelectedParamater(this.value);" id="questionType" disabled>
