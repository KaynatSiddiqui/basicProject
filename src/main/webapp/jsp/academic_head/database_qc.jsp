...
<%@include file="/jsp/master/default.jsp" %>
		...
		<div class="page-wrapper">
            <div class="container-fluid">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="button-list">
										...
										<a href="<%= AppConstants.BASE_URL %>academic_head/database_qc.jsp" class="btn btn-academic_head_tabs">Database Qc</a>
										...
										<div class="row">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select id="topic" class="selectpicker"  data-style="form-control btn-default btn-outline" onchange="getAllSQBLayouts()" disabled>
											...
											<div class="col-md-2">
												<a class="btn btn-primary mt-25" id="AhQCSubmit">Submit</a>
											</div>
										</div>
									</form>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="AHQC_tbl" class="table ahead_border  display pb-30" >
				...
				<input type="hidden" id="creationactive" value="dbqcsactive"/>
