							...
							<div class="panel-body">
								...
								<div class="mt-30">
									<a href="<%= AppConstants.BASE_URL %>academic_head/database_count.jsp" class="btn btn-primary pull-center">Back</a>
																...
																<button class="btn btn-download pull-right" type="submit" onclick="fnExcelReport('db_param_wise_count')" class="btn btn-warning" id="jquery-word-export">Download in Excel</button>
