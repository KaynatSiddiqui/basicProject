...
<input type="hidden" id="creationactive" value="1">	 
<input type="hidden" id="ulactive" value="1">	
<input type="hidden" id="ulactivechild" value="1">	
	...
	<!-- Main Content -->
			...
			<input type="hidden" value="" id="smeid">
...
$(document).ready(function() {
	...
	var ah_editmode = sessionStorage.getItem("ah_editmode");
		...
		if(questionId!=='' && questionId !== null && ah_editmode === "true" && bk === null) {
			...
			getSQBQuestionDataById(questionId, function(wholeQuestionData){
				...
				$("#smeid").val(wholeQuestionData[0].smeid);
				
				fillLayoutFields(wholeQuestionData,layout);

			});

		} else if(questionId!=='' && questionId !== null && bk !== "" && bk !== null) {
			$("#questionId").val(questionId);
		...
		} else if(pvid !== '' && pvid !== null){
			
			if(questionId!=='' && questionId !== null){
				$("#questionId").val(questionId);
				getSQBQuestionDataById(pvid, function(wholeQuestionData){
					$("#smeid").val(wholeQuestionData[0].smeid);
					fillLayoutFields(wholeQuestionData,layout);
