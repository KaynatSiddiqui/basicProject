...
display: inline-block;
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="smedatable_1" class="table table-bordered display pb-30" >
 ...
 <div class="modal fade" id="accapass" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" id="smeclose" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Academichead Password</h4>
        </div>
        <div class="modal-body">
        <div style="width:100%;display:inline-flex;justify-content:center;">
          <label for="acapass">Password:</label>&nbsp;&nbsp;
          <input type="text" id="accpassvalue" class="inputcontrol" placeholder="Enter academic password">
          </div>
          <button class="btn btn-success" style="display:block;margin:20px auto" id="submitpass">Submit</button>
        </div>
      </div>
    </div>
  </div>
        ...
        <script>
        $("#smelistactive").addClass('active-page');
