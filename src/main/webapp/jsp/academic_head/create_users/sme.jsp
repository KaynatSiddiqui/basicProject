...
<!-- Main Content -->
						...
						<div class="panel panel-default card-view">
							...
							<div class="row">
								<div class="col-sm-6 col-sm-offset-3">
									<!-- <form method="post" action="sme.jsp"> -->
										<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="emaile" name="example-email" class="form-control" placeholder="Enter Email Id">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
													<label class="control-label" >Sme Id</label>
												</div>
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="text" id="smeid" name="example-email" class="form-control" placeholder="Enter Sme Id">
												</div>
											</div>	
										</div>
										</div>
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													<input type="submit" class="btn  btn-primary" value="Add" onclick="smeRegisterUsers();">
												</div>
											</div>
										</div>
									<!-- </form> -->
	  ...
	  <script>
	  $("#smeactive").addClass('active-page');
