								...
								<div class="col-sm-12">
									<form>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="center">
												<a class="btn btn-primary" href="<%= AppConstants.BASE_URL %>academic_head/move_to_board.jsp">Save & Submit</a>
												<a class="btn btn-warning" href="<%= AppConstants.BASE_URL %>academic_head/move_to_board.jsp"> Cancel</a>
												</div>
											</div>
