...
<%@include file="/jsp/master/default.jsp" %>
		...
		<div class="page-wrapper">
            <div class="container-fluid">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="button-list">
										<a href="<%= AppConstants.BASE_URL %>academic_head/status.jsp" class="btn btn-academic_head_tabs">Question Status</a>
										...
										<div class="row">
											<!-- <div class="col-md-2">
												...
												<div class="form-group">
													...
													<select class="selectpicker" id="standard" onchange="getsubjectssqb(this.value);" data-style="form-control btn-default btn-outline" disabled>
											...
											<!-- <div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker" id="examtype" onchange="getSelectedSubjects(this.value);" data-style="form-control btn-default btn-outline" disabled>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker" id="subject" onchange="sqbgetallunits(this.value);" data-style="form-control btn-default btn-outline" disabled>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker" id="unit" onchange="getchapterssqb(this.value);" data-style="form-control btn-default btn-outline" disabled>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select class="selectpicker" id="chapter" onchange="getSelectedSQBTopics(this.value); gellAllSqbParamaters(this.value);getChapterwiseparms();" data-style="form-control btn-default btn-outline"  disabled>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select id="topic" class="selectpicker" onchange="getAllSQBLayouts()" data-style="form-control btn-default btn-outline"  disabled>
											...
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label mb-5 bold">Main Parameters </label>
											...
											<div class="col-md-1">
											<p style="font-size: 18px; position: relative; top: 33px; text-align: center;">Or</p>
									         </div>
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label mb-5 bold">Chapterwise Parameters </label>
													<select class="selectpicker"  data-style="form-control btn-default btn-outline" id="chapparameter" disabled>
														
													</select>
												</div>	
											</div>
											<div class="col-md-2">
												<a id="AhdeanSubmit" class="btn btn-primary mt-25">Submit</a>
											</div>
										</div>
									</form>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="AHDean_tbl" class="table ahead_border display pb-30" >
				...
				<input type="hidden" id="creationactive" value="statusactive"/>
   ...
   <%--    	<script src="<%=request.getContextPath()%>/assets/js/app.js"></script> --%>
	...
	$("#parameter").on("change", function(){
		$("#chapparameter").prop("disabled", true);
		$("#parameter").prop("disabled", false);
	})
	
	$("#chapparameter").on("change", function(){
