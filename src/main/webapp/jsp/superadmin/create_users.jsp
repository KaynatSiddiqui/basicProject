									...
									<form method="post" action="<?php echo base_url();?>superadmin/add_new_users">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="firstname" name="example-email" class="form-control" placeholder="Enter First Name">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="gender" data-style="form-control btn-default btn-outline">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="designation" name="example-email" class="form-control" placeholder="Enter Designation">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="pin" name="example-email" class="form-control" placeholder="Enter Pin Number">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="repin" name="example-email" class="form-control" placeholder="Enter Re Pin Number">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="password" name="example-email" class="form-control" placeholder="Enter Password">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
												<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
													<input type="email" id="repassword" name="example-email" class="form-control" placeholder="Enter Re-password">
												</div>
											</div>	
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="usertype" data-style="form-control btn-default btn-outline" id="type" Onchange="get_val();">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="features">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12" id="testcheckbox">
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													<input onclick ="adminUserCreation();" type="submit" class="btn  btn-primary" value="Add"/>
												</div>
											</div>
										</div>
									</form>
