						...
						<div class="">
							...
							<div class="row">
								<div class="col-sm-2" id="getspace">
								 <img src="<%=request.getContextPath()%>/assets/images/students/sidetitlecards/Attempted.svg" class="img-responsive">
								</div>
								<div class="col-sm-5">
									<div class="button-list">
										<a href="#Tab_2" id="sub" data-toggle="tab" role="tab" class="btn active"><%= AppConstants.SUBJECTWISE_MOCK %></a>
										<a href="#Tab_1" id="mock" data-toggle="tab" role="tab" class="btn"><%= AppConstants.MOCKTEST %></a>
			...
			if(getParameterByName('testtype') !="" || getParameterByName('testtype') != null){
				var currTabActive = getParameterByName('testtype');
				  ...
				  if(currTabActive !== null){
					...
					attempeted("Subject-Wise Test",exam);
				 }
		});
