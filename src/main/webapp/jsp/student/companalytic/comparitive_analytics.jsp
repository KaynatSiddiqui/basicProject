							...
							<br />
							      ...
							      <div class="col-sm-6 col-sm-offset-3" style="margin-bottom:30px">
										<div class="panel" style="background: #fff; margin-bottom: 12px;border-radius: 12px; box-shadow: 3px 5px 40px grey;
											...
											<div class="">
												<div class="center">
													<i id="idbefaftpercen" ><img src="<%=request.getContextPath()%>/assets/images/students/Percentile.svg" alt="logo" class="imgstyle-3"> <span style="margin-left:10px">Percentile</span></i>
												</div>
