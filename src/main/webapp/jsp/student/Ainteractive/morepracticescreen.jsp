	...
	<div onkeydown="return (event.keyCode != 116)">
		<div class="container-fluid mt-10">
			...
			<div class="heading col-sm-4">
						 ...
						 <p class="bold font-16 black" id="Paramname"  style="margin-left:15px;color:#00bfff"></p>
                 </div>
				<div class="col-sm-3">
					<div class="text-center">
					<img src="/zomanttesting/assets/images/students/chaptertargetimg/Timespentchapter.svg" alt="" style="height: 24px;width: 24px;vertical-align: middle;">
				...
				<div class="col-sm-2" style="text-align:right;">
				     <div id="">
                     <div class="">
							<a href="#" onclick="finishmorepractice();"  id="finishtest" class="btn  hvr-rectangle-out" style="display:none">FINISH</a>
							<a href="#" onclick="analytics('morepause');" class="btn" id="pause_btn" style="border-radius:15px;"><i class="fa fa-pause" ></i></a>	
						</div>
   ...
   <script src="<%=request.getContextPath()%>/assets/ckeditor/katexckeditor/katex.min.js"></script>
	...
	<script>
	 ...
	 $(document).ready(function(){
		...
		morepractice(chapter,subject,paramid,stage_btn); 
