...
<head>
    ...
    <!-- Title -->
    <title>JEE Advanced &centerdot; Skyget &centerdot; Engineering & Medical - Entrance Exam Expert</title>
                    ...
                    <div class="col-lg-6 col-xl-5 ml-xl-auto">
                        <div class="special_description_content">
                            ...
                            <div class="get-start-area zigBtn" >
                                <a class="submit" href="#" data-toggle="modal" data-target="#centralModalLg">Start</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="<%=request.getContextPath()%>/assets/landing/img/Jee-Advance.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div id='jeeadvancedmenu'>
                        <ul id="myTabs">
                           <li class='active'><a href='' class="anchor" data-related="jeeadvanced">What is JEE Advanced?</a></li>
                           <li><a href='' class="anchor" data-related="exampattern">Exam Pattern</a></li>
                           <li><a href='' class="anchor" data-related="cutoff">Cut-Off History</a></li>
                           <li><a href='' class="anchor" data-related="previous">Previous Years Papers</a></li>
                           <li><a href='' class="anchor" data-related="important">Important Dates</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-9">
                        ...
                        <div class="single-special  wow fadeInUp fasak active" data-wow-delay="0.4s" id="jeeadvanced">
                           ...
                           <div class="single-special  wow fadeInUp fasak" data-wow-delay="0.4s" id="exampattern">
                            <div class="text-center">
                                <h3>Exam Pattern</h3>
                            </div>
                            <div>
                            ...
                            <div class="single-special  wow fadeInUp fasak" data-wow-delay="0.4s" id="cutoff">
                            <div class="text-center">
                        ...
                        <div class="single-special  wow fadeInUp fasak" data-wow-delay="0.4s" id="previous">
                            <div class="text-center">
                                <h3>Previous years papers</h3>
                            </div>
                            <div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            ...
                            <div class="single-special  wow fadeInUp fasak" data-wow-delay="0.4s" id="important">
                            <div class="text-center">
