...
div#top_nav.active a{
            	...
            	<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<%-- <div class="panel" style="display:flex;margin:20px;box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.2);width:300px;">
							<div class="panel-body" style="display:flex ;align-items:center ;justify-content:flex-start">
							<img src="<%=request.getContextPath()%>/assets/images/students/WebHome/MotivationalVideos/wh64PX.png">
							<h3 class=" text-warning"style=";margin-left:5px;">Tricks & Logics</h3>
							</div>
							</div> --%>
							<div class="" style="display:flex;margin:20px;box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.2);width:300px;background:rgb(255, 245, 230)">
 ...
 <script src="<%=request.getContextPath()%>/assets/landing/js/tricks_logics.js"></script>
