...
alt="logo"></a>
            ...
            <a href="#" class="wobble-horizontal" id="freeaccess_btn" data-toggle="modal" data-target="#showmoreModal" data-backdrop="true">Show Paper</a>
						...
						<div role="tabpanel" class="tab-pane" id="subjectvsdifficulty">
                            <%@include file="/jsp/student/student module/studentanalaytic_chapterwise.jsp"%>
							</div>
						</div>
					</div>	
				</div>
	...
	<script>
		$(document).ready(function(){
			...
			//$( "#tabs" ).tabs();
	if(einsteinType === ""){
		$("#analyticsbtn").attr("href",base_url+"jsp/student/student module/student_analytics3.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid'));
		$("#comparativebtn").attr("href",base_url+"jsp/student/companalytic/comparitive_analytics.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid'));
		$("#toppersbtn").attr("href",base_url+"jsp/student/student module/student_analytics_toppers.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid'));
		$("#Collegepred").attr("href",base_url+"jsp/student/collegeprediction/collegepredanaly.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid'));
	} else{
	$("#analyticsbtn").attr("href",base_url+"jsp/student/student module/student_analytics3.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid')+"&from="+from+"&einsteinType="+einsteinType);
	$("#comparativebtn").attr("href",base_url+"jsp/student/companalytic/comparitive_analytics.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid')+"&from="+from+"&einsteinType="+einsteinType);
	$("#toppersbtn").attr("href",base_url+"jsp/student/student module/student_analytics_toppers.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid')+"&from="+from+"&einsteinType="+einsteinType);
	$("#Collegepred").attr("href",base_url+"jsp/student/collegeprediction/collegepredanaly.jsp?id="+getParameterByName('id')+"&exm="+getParameterByName('exm')+"&testtype="+getParameterByName('testtype')+"&examid="+getParameterByName('examid')+"&from="+from+"&einsteinType="+einsteinType);
	}		
