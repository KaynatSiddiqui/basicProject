...
<head>
    ...
    <!-- Title -->
    <title>AIIMS &centerdot; Skyget &centerdot; Engineering & Medical - Entrance Exam Expert</title>
...
<section class="special-area bg-white section-padding-80" id="contact" style="background:whitesmoke;margin-top:90px;box-shadow: rgba(0, 0, 0, 0.3) 0px 20px 30px -20px; margin-bottom: 290px;">

<div class="container" id="halfnotification">
