					...
					<div class="row mb-100">
						<div class="col-md-2">
							<div class="button-list">
								<a href="<?php echo base_url();?>student/practice_zone/simple_practice_final_summery" class="btn btn-exam_finish btn-sm">FINISH EXAM</a>
							</div>
						</div>
						<div class="col-md-2 col-md-offset-1">
							<div class="button-list">
								<a href="<?php echo base_url();?>student/practice_zone/get_questions_solution" class="btn btn-exam_submit btn-sm">SUBMIT</a>
							</div>
						</div>
						<div class="col-md-2 col-md-offset-3">
							<div class="button-list">
								<a href="<?php echo base_url();?>student/practice_zone/get_questions" class="btn btn-exam_skip btn-sm">SKIP</a>
							</div>
						</div>
					</div>
				</div>
