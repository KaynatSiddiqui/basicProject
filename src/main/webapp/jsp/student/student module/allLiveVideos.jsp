...
div#top_nav.active a{
            	...
            	<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							...
							<img class="img">
							<h3 class="" id="videoType" style="border-bottom:solid 2px #00008b;color:#00008b"></h3>
							</div> -->
							...
							<h3 class=" text-warning" id="videoType" style=";margin-left:5px;"></h3>
							</div>
							</div>
							<div class="row">
 ...
 <script src="<%=request.getContextPath()%>/assets/landing/js/allLiveVideos.js"></script>
