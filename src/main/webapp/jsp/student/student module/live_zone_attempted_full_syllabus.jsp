							...
							<div class="row">
								<div class="col-sm-8">
									<div class="button-list">
										<a href="<%= AppConstants.BASE_URL %>student/student module/live_zone_attempted_full_mocks.jsp" id="mock" href="#Tab_1" class="btn btn-livezone_attempted_btn btn-outline fancy-button btn-0"><%= AppConstants.MOCKTEST %></a>
										<a href="<%= AppConstants.BASE_URL %>student/student module/live_zone_attempted_subject_wise_mocks.jsp" id="sub" href="#Tab_2" class="btn btn-livezone_attempted_btn btn-outline fancy-button btn-0"><%= AppConstants.SUBJECTWISE_MOCK %> </a>
										<a href="<%= AppConstants.BASE_URL %>student/student module/live_zone_attempted_full_syllabus.jsp" id="full" href="#Tab_3" class="btn btn-livezone_attempted_btn"><%= AppConstants.FULLSYALLBUSMOCK %> </a>
									</div>
								</div>
								<div class="col-sm-4">
									<div  class="tab-struct custom-tab-1 mt-20">
										<!-- <ul role="tablist" class="nav nav-tabs sky_blue_tabs" id="myTabs_7">
										  ...
										  <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-style="form-control btn-default btn-outline"  id="examty">
