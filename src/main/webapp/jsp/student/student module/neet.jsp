...
<head>
    ...
    <!-- Title -->
    <title>NEET &centerdot; Skyget &centerdot; Engineering & Medical - Entrance Exam Expert</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="<%=request.getContextPath()%>/assets/landing/img/NEET.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div id='neetmenu'>
                        <ul id="myTabs">
                           <li class='active'><a href='' class="anchor" data-related="neet">What is NEET?</a></li>
                ...
                <div class="col-12 col-md-9">
                        ...
                        <div class="single-special  wow fadeInUp fasak active" data-wow-delay="0.4s" id="neet">
