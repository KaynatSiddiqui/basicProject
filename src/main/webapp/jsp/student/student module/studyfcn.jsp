...
div#top_nav.active a{
            	...
            	<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							...
							<img class="img">
							<h3 class="text-warning" id="type"><strong></strong></h3>
							</div> -->
							...
							<h3 class=" text-warning" id="type" style=";margin-left:5px;"></h3>
							</div>
							</div>
							<div class="row">
 ...
 <script src="<%=request.getContextPath()%>/assets/landing/js/studyfcn.js"></script>
