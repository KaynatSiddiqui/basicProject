					...
					<div class="panel panel-default card-view discussionbg">
						<div class="panel-heading">
							<div class="col-sm-4 pull-left">
								<h6 class="panel-title txt-dark"><span class="main_heading_blue">Saved </span><span class="main_heading_theme_color"> Threads</span></h6>
							</div>
						...
						<div class="row mb-20">
							<div class="col-sm-12">
								<div class="button-list">
									...
									<a href="<%= AppConstants.BASE_URL %>student/discussionforum/discussion_forum_saved.jsp" class="btn btn-danger">Saved Threads</a>
