						...
						<div class="col-sm-12 col-xs-12">
							...
							<div class="form-wrap">
									...
									<div class="form-group">
										<label class="control-label mb-10" for="exampleInputEmail_2">Enter Received Otp</label>
										<input type="text" class="form-control" id="genrat" placeholder="Enter Received Otp">
									</div>
									<div class="form-group">
										<a class="capitalize-font txt-primary block mb-10 pull-right font-12" onclick="regenerateotpforadmin()">Generate New Otp</a>
										<div class="clearfix"></div>
									</div>
									<div class="form-group text-center">
										<input type="submit" id="otpbtn" type="submit" class="btn btn-info btn-rounded" value="Login" onclick ="otpgenerate();"/>
									</div>
