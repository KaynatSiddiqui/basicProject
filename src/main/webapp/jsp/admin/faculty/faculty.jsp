...
<%@include file="/jsp/master/default.jsp" %>
	...
	<div class="my-5" style="display:flex; justify-content:end;margin-top:15px;">
		...
		<button class="btn btn-primary" onclick="registration()">Create Faculty</button>
	</div>
...
<div class="modal fade modalDialog" id="facultyview" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true"> 
...
<script src="<%=request.getContextPath()%>/assets/js/faculty.js"></script>
