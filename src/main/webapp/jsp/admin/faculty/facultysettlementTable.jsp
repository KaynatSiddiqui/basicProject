...
<div class="page-wrapper">
	...
	<div class="container-fluid">
			...
			<div class="panel-heading">
				<div class="col-sm-2 pull-left">
					<h6 class="panel-title txt-dark">
						<span class="creations_heading">Faculty Settlement</span>
					</h6>
				</div>
			</div>
		</div>
		...
		<a href="facultysettlementadmin.jsp" class="btn btn-primary">Create Settlement</a>
		</div>
				...
				<div class="my-5"
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="row">
							...
							<div class="col-md-3">
								<label for="selectsalesman">Facultys</label>
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.js"></script>
  ...
  <script>
  $("#facultysettement").addClass('active-page');
  $(document).ready( function () {
	...
	<script src="<%=request.getContextPath()%>/assets/js/facultysettlementTable.js"></script>
