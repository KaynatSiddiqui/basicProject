	...
	<!-- Main Content -->
		<div class="page-wrapper">
            <div class="container-fluid">
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark" onclick=""><span class="main_heading_blue">Chapter Expertise Percentage</span><span class="main_heading_theme_color" onclick=""> Add</span></h6>
								</div>
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													...
													<a class="btn  btn-primary" id="chapterexpertisepercentage" onclick="chapExpPercentagePost();">Add</a>
												</div>
											</div>
										</div>
									</form>
				...
				<input type="hidden" id="creationactive" value="chapterpercent"/>
		</div>
