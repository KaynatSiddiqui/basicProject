						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark"><span class="main_heading_blue">Videos</span><span class="main_heading_theme_color"> Edit</span></h6>
								</div>
									...
									<form>
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
														<label class="control-label" for="example-email">ExamType Name </label>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
										   ...
										   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row form-group">
															...
															<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
															<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
															<input type="text" id="videotext" name="videourl" class="form-control" placeholder="Viedo text" required>
																</div>
														</div>	
										   </div>
										</div>
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													...
													<a  class="btn  btn-primary" onclick="sqbvideoupdate();" >Save</a>
												</div>
											</div>
										</div>
									</form>
