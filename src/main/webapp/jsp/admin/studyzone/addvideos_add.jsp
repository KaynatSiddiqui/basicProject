						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark" onclick=""><span class="main_heading_blue">Videos</span><span class="main_heading_theme_color" onclick=""> Add</span></h6>
								</div>
										...
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
														<select class="selectpicker" data-style="form-control btn-default btn-outline" id="subject" onchange="sqbgetallunits(this.value); sqbsubparamters(this.value);" >
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row form-group">
															<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
																<label class="control-label" for="example-email">Video URL</label>
															</div>
															<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
															<div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
															<input type="text" id="videourl" name="videourl" class="form-control" placeholder="Viedo url" required>
										   		...
										   		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row form-group">
															<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
																<label class="control-label" for="example-email">Video Text</label>
															</div>
															<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
															<div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
															<input type="text" id="videotext" name="videotext" class="form-control" placeholder="Viedo text" required>
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													<a href="<%= AppConstants.BASE_URL %>admin/studyzone/addvideos.jsp" class="btn  btn-info">Back</a>
													<a class="btn  btn-primary" onclick="sqbPostAddvideo();">Add</a>
												</div>
											</div>
										</div>
									</form>
