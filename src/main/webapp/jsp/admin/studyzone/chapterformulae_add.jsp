						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark" onclick=""><span class="main_heading_blue">Chapter Formulae</span><span class="main_heading_theme_color" onclick=""> Add</span></h6>
								</div>
									...
									<form>
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="row form-group">
															<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
																<label class="control-label" for="example-email">Chapter Formulae</label>
															</div>
															<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
															<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
																<textarea class="textarea_editor form-control" class="selectpicker formulae" rows="15" id="editor1" placeholder="Enter text ..."></textarea>
															</div>
														</div>	
										   </div>
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													<a href="<%= AppConstants.BASE_URL %>admin/studyzone/chapterformulae.jsp" class="btn  btn-info">Back</a>
													<a class="btn  btn-primary" onclick="chapterFormulae();">Add</a>
												</div>
											</div>
										</div>
									</form>
