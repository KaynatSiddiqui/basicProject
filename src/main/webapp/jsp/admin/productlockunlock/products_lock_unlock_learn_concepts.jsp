							...
							<div class="row mb-10 mt-20">
								<div class="col-sm-12">
									<div class="button-list center">
										...
										<a href="<?php echo base_url();?>admin/products_lock_unlock/learn_concepts" class=" btn btn-product_lock_unlock_active">learn Concepts</a>
									</div>
								</div>
							</div>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-bordered display pb-30">
												<thead class="th_background">
													<tr>
														<th>Chapter Name</th>
														<th>Concepts</br>(No.of Topics)</th>
														<th>Videos Count</th>
														<th>Posted Date</th>
														<th>Lock/ Unlock</th>
													</tr>
												...
												<tbody>
													...
													<tr>
														...
														<td>17-02-2018</td>
														<td>
															<a href="#"><span class="btn btn-primary status_btn">Unlock</span></a>
														</td>
													</tr>
													<tr>
														<td>Chapter - 3</td>
