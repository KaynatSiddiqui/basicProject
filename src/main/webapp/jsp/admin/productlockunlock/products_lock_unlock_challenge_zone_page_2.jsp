                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
							...
							<div class="row mt-10 mb-10">
								<div class="col-sm-12">
									<div class="button-list center">
										<a href="<?php echo base_url();?>admin/products_lock_unlock/challenge_zone" class="btn btn-post_doubt_expert_inactive">Zones</a>
										<a href="<?php echo base_url();?>admin/products_lock_unlock/challenge_zone_page_2" class="btn btn-post_doubt_expert_active">Expert Posts</a>
									</div>
								</div>
							</div>
