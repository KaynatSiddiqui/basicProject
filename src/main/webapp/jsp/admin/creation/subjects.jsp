					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="col-md-2">
									<a class="btn btn-primary mt-25" onclick="getAllSubjects();">Submit</a>	
								</div>
								<div class="col-md-2 right">
									<a href="<%= AppConstants.BASE_URL %>admin/creation/subjects_add.jsp" class="btn btn-success btn-xs">Add</a>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="subjects_tbl" class="table display pb-30" >
												...
												<tbody id="subjects_tbody">
													<%-- <tr>
														...
														<td>
															<div class="">
																<a href="<%= AppConstants.BASE_URL %>admin/creation/subjects_edit.jsp" class="btn btn-edit btn-icon-anim btn-circle mr-10" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit font-18 mt-10"></i></a>
