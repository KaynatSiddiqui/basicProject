						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-2 pull-left">
									<h6 class="panel-title txt-dark"><span class="creations_heading">Topics</span></h6>
								</div>
							<div class="col-md-3">
								...
								<div class="col-md-3">
									...
									<a class="btn btn-primary mt-25" onclick="GetAllTopic();">Submit</a>	
								</div>
								<div class="col-md-2 right">
									<a href="<%= AppConstants.BASE_URL %>admin/creation/topics_add.jsp" class="btn btn-success btn-xs">Add</a>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="topics_tbl" class="table display pb-30" >
												...
												<tbody id="topics_tbody">
													<%-- <tr>
														...
														<td>
															<div class="">
																<a href="<%= AppConstants.BASE_URL %>admin/creation/topics_edit.jsp" class="btn btn-edit btn-icon-anim btn-circle mr-10" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit font-18 mt-10"></i></a>
