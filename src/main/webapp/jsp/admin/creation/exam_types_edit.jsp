								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<input type="email" id="examtype" name="examtype"
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<input type="email" id="examtypedetails" name="examtype"
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<span><input type="radio" class="checking"
													name="radio" id="yes" value="yes"><label for="yes">Yes</label>
												</span> <span><input type="radio" class="checking"
													name="radio" id="No" value="No"><label for="No">No</label></span>
												<div id="sections"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<img id="imgexa" height="150"
													src="http://via.placeholder.com/150x150"
													class="student_profile_img"> <input type="hidden"
													id="base66photo" value=""> <label id="image">Upload
													Profile image <input type="file" id="easimage">
												</label>
...
<script>
 document.getElementById("easimage").addEventListener("change", readFile);
	 function readFile() {
		  ...
		  if (this.files && this.files[0]) {
		    ...
		    FR.addEventListener("load", function(e) {
		      document.getElementById("imgexa").src  = e.target.result;
		      document.getElementById("base66photo").value = e.target.result;
		    }); 
