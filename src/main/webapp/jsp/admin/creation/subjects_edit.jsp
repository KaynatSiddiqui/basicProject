						...
						<div class="col-sm-4 pull-left">
							<h6 class="panel-title txt-dark">
								<span class="main_heading_blue">Subjects</span><span
									class="main_heading_theme_color"> Edit</span>
							</h6>
						</div>
								...
								<div class="row">
										...
										<div class="row form-group">
											...
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<select class="selectpicker"
													...
													id="category" onchange="getstandardsbtcat(this.value)" disabled>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<select class="selectpicker"
													data-style="form-control btn-default btn-outline"
													id="standard" disabled onchange="getSelectedexams(this.value); getCreationssubjectssqb(this.value);" >
													<!-- 	<option>--- Select ---</option>
									...
									<!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<input type="email" id="subjectname" name="subjectname"
										...
										<div class="row form-group">
											...
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<img id="img" height="150"
													...
													id="base70photo" value=""> <label id="image">Upload
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<img id="img2" height="35"
													src="http://via.placeholder.com/150x150"
													class="student_pro_img"> <input type="hidden"
													id="base50photo" value=""> <label id="image">Upload
												   Icon <input type="file" id="sub-icon">
												</label>
									...
									<div class="col-md-6 col-md-offset-4">
										<div class="button-list mt-25">
											<a
												...
												class="btn  btn-info">Back</a> <a id="sub_edit"
												class="btn  btn-primary" onclick="editSubjects();">Save</a>
										</div>
									</div>
								</div>
							</form>
...
$("#subselect").addClass('active-page');
	       $(document).ready(function() {
	    	   ...
	    	   var subjid = getParameterByName('id');
	    	   getSubjectById();
...
<script>
 document.getElementById("staeimage").addEventListener("change", readFile);
	 function readFile() {
		  ...
		  if (this.files && this.files[0]) {
		    ...
		    FR.addEventListener("load", function(e) {
		      ...
		      document.getElementById("base70photo").value = e.target.result;
		    }); 
	 ...
	 document.getElementById("sub-icon").addEventListener("change", SubFile);
	 function SubFile() {
		  ...
		  if (this.files && this.files[0]) {
		    ...
		    FR.addEventListener("load", function(e) {
		      ...
		      document.getElementById("base50photo").value = e.target.result;
		    }); 
