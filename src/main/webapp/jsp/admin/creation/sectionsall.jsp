						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-6 col-xs-12 pull-left">
									<h6 class="panel-title txt-dark"><span class="creations_heading">Sections</span></h6>
								</div>
								<div class="col-sm-4 col-xs-6 right">
									<a href="sections.jsp" class="btn btn-add_btn btn-xs">Add</a>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											...
											<table id="sections_tbl" class="table display pb-30" >
											<div id="loading">
												<p>Loading...</p></div>
