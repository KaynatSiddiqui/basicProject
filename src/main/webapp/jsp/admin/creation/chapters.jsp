					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="col-md-2 ">
									<a class="btn btn-primary mt-25" onclick="getAllChapter();">Submit</a>	
								</div>
								<div class="col-md-2 right">
									<a href="<%= AppConstants.BASE_URL %>admin/creation/chapters_add.jsp" class="btn btn-success btn-xs">Add</a>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="chapter_tbl" class="table display pb-30" >
