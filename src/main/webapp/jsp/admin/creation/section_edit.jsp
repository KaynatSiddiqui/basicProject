						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark"><span class="main_heading_blue">Sections</span><span class="main_heading_theme_color"> Edit</span></h6>
								</div>
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													...
													<a class="btn  btn-primary" role="button" id="upsec" onclick="updatesection()" >Add</a>
												</div>
											</div>
										</div>
									</form>
