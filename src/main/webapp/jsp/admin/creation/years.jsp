						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-3 pull-left">
									<h6 class="panel-title txt-dark"><span class="creations_heading">Years</span></h6>
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-2 ">
									<a class="btn btn-primary mt-25" onclick="GetAllYears();">Submit</a>	
								</div>
								<div class="col-md-2 right">
									<a href="<%= AppConstants.BASE_URL %>admin/creation/years_add.jsp" class="btn btn-success btn-xs">Add</a>
								</div>
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="years_tbl" class="table display pb-30" >
												...
												<tbody id="years_tbody">
													<%-- <tr>
														...
														<td>
															<div class="">
																<a href="<%= AppConstants.BASE_URL %>admin/creation/years_edit.jsp" class="btn btn-edit btn-icon-anim btn-circle mr-10" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit font-18 mt-10"></i></a>
