				...
				<div class="col-sm-12">
					<div class="panel panel-default card-view">
						...
						<!-- 	<div class="col-md-4">
							...
							<div class="col-md-2 ">
								<a class="btn btn-primary mt-25" onclick="getAllStandards();">Submit</a>	
							</div> -->
							<div class="col-sm-4 col-xs-6 right">
								<a href="<%= AppConstants.BASE_URL %>admin/creation/standards_add.jsp" class="btn btn-success btn-xs">Add</a>
							</div>
							...
							<div class="panel-body">
								<div class="table-wrap">
									<div class="table-responsive">
										<table id="std_tbl" class="table display pb-30" >
