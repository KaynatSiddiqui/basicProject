						...
						<div class="row">
							<div class="col-sm-12">
								<div class="button-list">
									<a href="<?php echo base_url();?>admin/controlling/mock_papers_structure_subject_wise" class="btn btn-danger">Subject wise</a>
									<a href="<?php echo base_url();?>admin/controlling/mock_papers_structure_section_wise" class="btn btn-danger btn-outline fancy-button btn-0">Section wise</a>
								</div>
							</div>
						</div>
						<hr class="light-grey-hr mb-10">
