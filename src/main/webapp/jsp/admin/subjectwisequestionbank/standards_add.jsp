									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row form-group">
											...
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<input type="email" id="sqbstandard" name="example-email"
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-4">
										<div class="button-list mt-25">
													<a href="<%= AppConstants.BASE_URL %>admin/subjectwisequestionbank/standards.jsp"
												class="btn  btn-info">Back</a> 
											<a class="btn  btn-primary" role="button" id="sqbstaadd" onclick="sqbstandardadd()">Add</a>
										</div>
									</div>
								</div>
							</form>
