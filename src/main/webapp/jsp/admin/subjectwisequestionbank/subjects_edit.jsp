										...
										<div class="row form-group">
											...
											<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
												<img id="img1" height="35"
													...
													id="base59photo1" value=""> <label id="image">Upload
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-4">
										<div class="button-list mt-25">
											<a href="<%= AppConstants.BASE_URL %>admin/subjectwisequestionbank/subjects.jsp" class="btn  btn-info">Back</a> 
												<a id="sub_edit"class="btn  btn-primary" id="sqbsubedit" onclick="sqbSubjectUpdate()">Save</a>
										</div>
									</div>
								</div>
							</form>
...
$("#sbsubject").addClass('active-page');
	       $(document).ready(function() {
	   				...
	   				editsqbSubject(function(){
       			
       		        }); */
	    	   subchapAllSqbParamaters(function(){
	    		   editsqbSubject();
	    	   })
	   });
	 ...
	 function SubFile() {
		  ...
		  if (this.files && this.files[0]) {
		    ...
		    FR.addEventListener("load", function(e) {
		      ...
		      document.getElementById("base59photo1").value = e.target.result;
		    }); 
