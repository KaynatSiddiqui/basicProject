						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark"><span class="main_heading_blue">Parameters</span><span class="main_heading_theme_color"> Edit</span></h6>
								</div>
										...
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group" style="display:flex">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="standard"  data-style="form-control btn-default btn-outline" onchange="getsubjectssqb(this.value);" disabled>
												...
												<div class="row form-group" style="display:flex">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="subject"   data-style="form-control btn-default btn-outline" onchange="sqbgetallunits(this.value);" disabled>
															<!-- <option>--- Select ---</option>
															<option>Science</option>
															<option>Social</option> -->
														</select>
												...
												<div class="row form-group" style="display:flex">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="unit"   data-style="form-control btn-default btn-outline" onchange="getchapterssqb(this.value);" disabled>
															<!-- <option>--- Select ---</option>
															<option>Science</option>
															<option>Social</option> -->
														</select>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group" style="display:flex">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<select class="selectpicker" id="chapter" multiple  data-style="form-control btn-default btn-outline" disabled>
															<!-- <option>--- Select ---</option>
															<option>Science</option>
															<option>Social</option> -->
														</select>
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													...
													<a  class="btn  btn-primary" onclick="sqbParameterUpdate();" >Save</a>
												</div>
											</div>
										</div>
									</form>
