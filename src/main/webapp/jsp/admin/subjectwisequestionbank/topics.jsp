						...
						<div class="panel panel-default card-view">
							...
							<div class="col-md-3">
								...
								<div class="col-md-3">
									...
									<a class="btn btn-primary mt-25" onclick="sqbAllTopicsbyStdandSub()">Submit</a>	
								</div>
								<div class="col-md-2 right">
									<a href="<%= AppConstants.BASE_URL %>admin/subjectwisequestionbank/topics_add.jsp" class="btn btn-success btn-xs">Add</a>
								</div>
