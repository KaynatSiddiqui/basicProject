		...
		<div class="panel panel-default card-view">
			...
			<div class="row">                  
	           <div class="col-sm-4 mb-30">
					<h6 class="panel-title txt-dark"><span class="main_heading_blue">Layout 4</span><span class="main_heading_theme_color"> Multi Correct</span></h6>
				</div>
									...
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox1" value="A" class="optionChecks" type="checkbox">
												<label for="checkbox1">
													A)
												</label>
											</div>		
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox2" value="B" class="optionChecks" type="checkbox">
												<label for="checkbox2">
													B)
												</label>
											</div>	
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox3" value="C" class="optionChecks" type="checkbox">
												<label for="checkbox3">
													C)
												</label>
											</div>	
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
										<div class="checkbox checkbox-success">
											<input id="checkbox4" value="D" class="optionChecks" type="checkbox">
											<label for="checkbox4">
												D)
											</label>
										</div>	
