		...
		<div class="panel panel-default card-view">
			...
			<div class="row">                  
	           <div class="col-sm-4 mb-30">
					<h6 class="panel-title txt-dark"><span class="main_heading_blue">Layout 6</span><span class="main_heading_theme_color"> Multi Correct</span></h6>
				</div>
									...
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox1" value="1" class="optionChecks" type="checkbox">
												<label for="checkbox1">
													1)
												</label>
											</div>		
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox2" value="2" class="optionChecks" type="checkbox">
												<label for="checkbox2">
													2)
												</label>
											</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox3" value="3" class="optionChecks" type="checkbox">
												<label for="checkbox3">
													3)
												</label>
											</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row form-group">
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="checkbox4" value="4" class="optionChecks" type="checkbox">
												<label for="checkbox4">
													4)
												</label>
											</div>	
