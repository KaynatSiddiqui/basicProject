									...
									<form>
											...
											<!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													<div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">
														<label class="control-label" for="example-email">Advertisement Method </label>
													</div>
										...
										<div class="row form-group">
											<div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
												<label class="control-label" for="example-email">PromoCode Type
													 </label>
											</div>
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
												...
												<div class="row form-group">
													<div class="col-lg-3 col-md-3 col-sm-3 col-xs-10">
														<div>
															...
															<label class="control-label" for="checkbox3">Email Id</label>
														</div>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<input type="email" id="emailId" name="example-email" class="form-control" placeholder="Enter Emailid">
													</div>
												</div>	
											</div> -->
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="row">
											<div class="col-md-6 col-md-offset-5">
												<div class="button-list mt-25">
													...
													<a onclick="createPromocode()" id="promoadd" class="btn  btn-primary">Add</a>
												</div>
											</div>
										</div>
									</form>
