...
<div class="page-wrapper">
	<div class="container-fluid">
        ...
        <input type="hidden" id="base67photos" value="">
         <label id="image">Upload Profile image <input type="file" id="feedbacksimage"></label>									</div>
									</div>
									</div>
								...
								<div class="row mb-20">
									<div class="col-md-6 col-md-offset-4">
										<div class="button-list mt-25">
											<a href="#" onclick="newscreation()" class="btn  btn-primary">Create</a>
										</div>
										</div>
									</div>
								</div>
