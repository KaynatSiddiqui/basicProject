						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="col-sm-4 pull-left">
									<h6 class="panel-title txt-dark"><span class="test_post_title_first">Test Post History</span><span class="test_post_title_second"> - Control</span></h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
									...
									<div class="row mt-20">
										<div class="col-sm-8 col-sm-offset-4">
											<div class="button-list">
												...
												<a href="<?php echo base_url();?>admin/test_post/history_all_posts" class="btn btn-danger">All Posts</a>
												<a href="<?php echo base_url();?>admin/test_post/history_print_paper" class="btn btn-danger btn-outline fancy-button btn-0">Print Paper</a>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-12">
										...
										<div class="col-sm-12">
												<div class="col-md-3">
											<div class="form-group">
												<label class="control-label mb-5 bold">Zone Type <span class="red">*</span></label>
												<select class="selectpicker" data-style="form-control btn-default btn-outline" id="zonetype">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="selectpicker" data-style="form-control btn-default btn-outline" id="testtype">
												    <option>--- Select ---</option>
											...
											<div class="col-md-2">
												<a class="btn btn-primary mt-25" onclick="testposthistfil('testposthistory',1)">Submit</a>
											</div>
									</div>
									</form>
	...
	<div class="modal fade" id="expiryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
	   ...
	   <script src="<%=request.getContextPath()%>/assets/js/testpost.js"></script>
        ...
        $(document).ready(function(){
        	...
        	Testposthistoryget("testposthistory",1);
        	getCategoriesByName();
