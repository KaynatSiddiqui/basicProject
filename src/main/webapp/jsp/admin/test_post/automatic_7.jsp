										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group center">
													<span class="sky_blue1 bold font-21">Engineering</span> <i class="fa fa-arrow-right green"></i>
													<span class="sky_blue1 bold font-21">Advanced</span> <i class="fa fa-arrow-right green"></i>
													<span class="sky_blue1 bold font-21">11th & 12th </span> <i class="fa fa-arrow-right green"></i>
													<span class="sky_blue1 bold font-21"> Test Zone</span> <i class="fa fa-arrow-right green"></i>
													<span class="sky_blue1 bold font-21">Test Type</span> <i class="fa fa-arrow-right green"></i>
													<span class="sky_blue1 bold font-21">Group Name</span>
												</div>	
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<input type="text" class="form-control" value="Test name here">
													</div>
												</div>	
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<input type="text" class="form-control" value="Unique features of the test" >
													</div>
												</div>	
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<input type="text" class="form-control" value="Ramu" >
													</div>
												</div>	
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="row form-group">
													...
													<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
													<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
														<input type="email" id="example-email" name="example-email" class="form-control" placeholder="24 hrs Format">
													</div>
												</div>	
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="row mb-30">
											<div class="col-md-7 col-md-offset-4">
												<div class="button-list mt-25">
													<a href="<%= AppConstants.BASE_URL %>admin/test_post/automatic_6.jsp" class="btn  btn-warning">Back</a>
													<a href="<%= AppConstants.BASE_URL %>admin/test_post/automatic_8.jsp" class="btn  btn-primary">Next</a>
