                                       ...
                                       <!--  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">:</div>
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-10" id="feedbackmsg"> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="center mb-20"> <a href="<%=AppConstants.BASE_URL%>admin/feedbacks/feedbacks.jsp" class="btn  btn-danger">Back</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                       ...
                       // $("#subscribe").html(data.subscribe);
                        $("#mailid").html(data.emailId);
                        $("#mobilenum").html(data.mobilenumber);
                       ...
                       // $("#producttype").html(data.producttype);
                        ...
                        $("#feedbackmsg").html(data.feedback);
                    },
                    error: function(data) {
                        alert("NO data Found");
                    }   
