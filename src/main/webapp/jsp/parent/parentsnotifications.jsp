...
'<div class="row ">'+
'<a href="parentnotifications_view.jsp?id='+data[i].id+'" onclick="notificationstatus('+data[i].id+');" >'+
	...
	'<div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">'+
	    ...
	    '<a href="#" class="" id="notifdelete" data-id="'+data[i].id+'_Application"><i class="fa fa-trash fa-2x" aria-hidden="true" style="float: right"></i></a>'+
		'</div>'+
'</div>'+
'</div>'+
	...
	if(data[i].notificationSeen == false){
		...
		'<div class="row ">'+
		 '<a href="parentnotifications_view.jsp?id='+data[i].id+'" onclick="notificationstatus('+data[i].id+');">'+
			...
			'</a>'+
			'<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">'+
		    '<a href="#" class="" id="notifdelete" data-id="'+data[i].id+'_Promotional"><i class="fa fa-trash fa-2x" aria-hidden="true" style="float: right"></i></a>'+
			'</div>'+
		'</div>'+
	'</div>'+
