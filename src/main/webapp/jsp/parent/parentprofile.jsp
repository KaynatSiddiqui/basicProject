								...
								<div class="row mt-10">
													...
													<div class="row" id="profile">
														 <div class="col-md-12 form-group">
															...
															<i class="fa fa-users" aria-hidden="true" style="color:red;"></i>
																<label class="control-label mb-5 bold">Parent Name</label>
															</div>
															<div class="col-md-1">:</div>
															<div class="col-md-7" id="parentsname">
														...
														<div class="col-md-12 form-group">
															<div class="col-md-4">
															  <i class="active fa fa-mobile prefix" style="color:red;"></i>
																<label class="control-label mb-5 bold">Parent Phone</label>
															</div>
															<div class="col-md-1">:</div>
															<div class="col-md-7" id="parentphonenum">
														...
														<div class="col-md-12 form-group">
															<div class="col-md-4">
															  <i class="active fa fa-mobile prefix" style="color:red;"></i>
																<label class="control-label mb-5 bold">Student Phone</label>
															</div>
															<div class="col-md-1">:</div>
														...
														<div class="col-md-12 form-group">
															<div class="col-md-4">
															 <i class="active fa fa-envelope prefix" style="color:red;"></i>
																<label class="control-label mb-5 bold">Parent Email ID</label>
															</div>
															<div class="col-md-1">:</div>
															<div class="col-md-7" id="parentemail">
														...
														<div class="col-md-12 form-group">
															<div class="col-md-4">
															 <i class="active fa fa-envelope prefix" style="color:red;"></i>
																<label class="control-label mb-5 bold">Student Email ID</label>
															</div>
															<div class="col-md-1">:</div>
														...
														<div class="col-md-12 form-group">
															...
															<i class="fa fa-briefcase" aria-hidden="true" style="color:red;"></i>
																<label class="control-label mb-5 bold">Occupation</label>
															</div>
															<div class="col-md-1">:</div>
															<div class="col-md-7" id="parentoccupation">
														...
														<div class="col-md-12 form-group">
															...
															<i class="active fa fa-venus-mars prefix" style="color:red;"></i>
																<label class="control-label mb-5 bold">Gender (student)</label>
															</div>
															<div class="col-md-1">:</div>
												...
												<!-- 	<div class="row mb-20">
													...
													<div class="row mb-20">
														...
														<div class="button-list mt-25">
															...
															<a href="dash.jsp" class="btn  btn-primary">back</a>
														</div>
													</div>
													</div> 
												</form>
									...
									<div class="col-sm-3">
										<div class='col-md-12 form-group'>
														...
														<div class='col-md-1'>:</div>
														<div class='col-md-7'><img id='parentimg' height='150' src="" class='student_profile_img'></div>
													</div>
									</div>
								</div>
							</div>
