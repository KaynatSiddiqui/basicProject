						...
						<div class="panel-heading">
							<div class="col-sm-1 col-xs-6 pull-left left">
									<a href="#" class="left inline-block  mr-15">
										  <span><img src="<%=request.getContextPath()%>/assets/images/students/feedback/Feedback_head_color.svg" id="paddon" width="240px"></span> 
									</a>
								</div>
							...
							<div class="row mb-20">
								<div class="col-sm-12">
									<div class="button-list butnlist">
										<a href="<%= AppConstants.BASE_URL %>parent/parentsfeedback.jsp" class="feedbacks_heading  mr-20 foo"><img src="<%=request.getContextPath()%>/assets/images/students/posted_color-(white-borders)_png.png" id="bg" width="40px">&nbsp;&nbsp;Posted</a>
									<a href="<%= AppConstants.BASE_URL %>parent/feedbacks_post_new.jsp" class="feedbacks_heading active mr-20 soo"><img src="<%=request.getContextPath()%>/assets/images/students/postnew_color.png" id="gb" width="40px">&nbsp;&nbsp;Post New</a>
								</div>
								</div>
							</div>
							<div class="row">
										...
										<div class="row mb-20">
											<div class="col-md-6 col-md-offset-4">
												<div class="button-list mt-25">
													<a href="#" onclick="addfeedbackpar();" class="btn  btn-primary">Add</a>
												</div>
											</div>
										</div>
									</form>
	 ...
	 function addfeedbackpar(){
		...
		//	var feedback = CKEDITOR.instances.editor1.getData();
            ...
            // var studentid = $("#studentid").val();
				var inputData = '{"regarding":"'+regarding+'","feedback":"'+feedback+'","fileUpload":"'+photo+'","createdBy":"'+createdby+'","parentId":"'+pId+'","sourceType":"web","userType":"parent"}';
				  ...
				  success: function(data){
					 ...
					 /*  alert('feedback saved successfully'); */
					  window.setTimeout(function(){
						  window.location = base_url+"jsp/parent/parentsfeedback.jsp";
					  }, 1000);
				  },
				  error: function(data) {		
