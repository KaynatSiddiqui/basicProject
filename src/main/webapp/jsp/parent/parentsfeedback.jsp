						...
						<div class="row">
							<div class="col-sm-12">
								<div class="button-list">
									<a href="<%= AppConstants.BASE_URL %>parent/parentsfeedback.jsp" class="feedbacks_heading active mr-20 foo"><img  src="<%=request.getContextPath()%>/assets/images/students/posted_color-brown_svg.svg" id="bg" width="40px">&nbsp;&nbsp;Posted</a>
									<a href="<%= AppConstants.BASE_URL %>parent/feedbacks_post_new.jsp" class="feedbacks_heading mr-20 soo"><img  src="<%=request.getContextPath()%>/assets/images/students/postnew_gray.png" id="gb" width="40px">&nbsp;&nbsp;Post New</a>
								</div>
							</div>
						</div>
	 ...
	 $(document).ready(function(){
		...
		/*  $("#nme").html(loginData.name);
		 ...
		 $("#studentid").val(loginData.studentid); */
			$("#parentname").html(sessionStorage.getItem('parentsname'));
		 
			var appenddata="";
			   var studentid = $("#studentid").val();
			$.ajax({
				url: base_url+'rest/feedback/v1/getAllParentFeedbackDetails/'+loginData.parentId,
				type:"GET",
				dataType:"json",
				...
				success:function(data){
				    ...
				    ' </div>'+
				     ...
				     '<p style="text-align:center;" id="">'+data[i].feedback+' </p>'+
				     '</div>';
