...
<div class="form">
		...
		<img src="<%=request.getContextPath()%>/assets/images/students/Faculty_img.png" style="height:202px;">
...
<div class="" style="display:flex;justify-content:space-around; align-items:center; margin-top:5px;">
    <a href="facultyprivacy.jsp" style="margin-left:50px;">Privacy</a>
    <a href="facultyterms.jsp" style="margin-right:100px;">Terms</a>
</div>
...
{
//   alert("The URL of : ");
   location.replace("https://www.skyget.ai/faculty/jsp/faculty_login.jsp");
...
<script src="<%=request.getContextPath()%>/faculty/js/facultylogin.js"></script>
