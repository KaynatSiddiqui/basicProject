! function(t, e) {
    ...
    var e = "SweetAlert2:",
        ...
        k = function(t, e) {
            var n;
            n = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "').concat(e, '" instead.'), -1 === g.indexOf(n) && (g.push(n), m(n))
        },
        B = function(t) {
    ...
    var P, L = function(t) {
        ...
        st = function(t) {
            ...
            if ((e = R()) && (e.parentNode.removeChild(e), T([document.documentElement, document.body], [S["no-backdrop"], S["toast-shown"], S["has-column"]])), it()) C("SweetAlert2 requires document to initialize");
                ...
                g.appendChild(n), i = t, (r = U()).setAttribute("role", i.toast ? "alert" : "dialog"), r.setAttribute("aria-live", i.toast ? "polite" : "assertive"), i.toast || r.setAttribute("aria-modal", "true"), a = g, "rtl" === window.getComputedStyle(a).direction && O(R(), S.rtl), s = K(), u = M(s, S.input), c = M(s, S.file), l = s.querySelector(".".concat(S.range, " input")), d = s.querySelector(".".concat(S.range, " output")), p = M(s, S.select), f = s.querySelector(".".concat(S.checkbox, " input")), m = M(s, S.textarea), u.oninput = at, c.onchange = at, p.onchange = at, f.onchange = at, m.oninput = at, l.oninput = function(t) {
    ...
    bt.text = bt.email = bt.password = bt.number = bt.tel = bt.url = function(t) {
        var e = M(K(), S.input);
        return "string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : x(t.inputValue) || m('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(w(t.inputValue), '"')), vt(e, t), e.type = t.input, e
    }, bt.file = function(t) {
        var e = M(K(), S.file);
    ...
    var yt = function(t, e) {
        ...
        kt = function(t, u) {
            var c = Z();
            if (!u.progressSteps || 0 === u.progressSteps.length) return q(c);
            j(c), c.innerHTML = "";
            ...
            l >= u.progressSteps.length && m("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), u.progressSteps.forEach(function(t, e) {
                var n, o, i, r, a = (n = t, o = document.createElement("li"), O(o, S["progress-step"]), o.innerHTML = n, o);
            ...
            y(a, e.customClass, "header"), kt(0, e),
                function(t, e) {
                    ...
                    if (n && e.type === n.type && z()) y(z(), e.customClass, "icon");
                        ...
                        if (Ct(), -1 !== Object.keys(h).indexOf(e.type)) {
    ...
    function Zt(t) {
        var e = R(),
            ...
            r = o.onClose,
            a = o.onAfterClose;
        n && (null !== r && "function" == typeof r && r(n), T(n, S.show), O(n, S.hide), lt && !b(n, S.noanimation) ? n.addEventListener(lt, Ft.bind(null, n, e, a)) : Kt(e, a), i(t || {}))
    }
    var Qt = function(t) {
    ...
    var te = function(t) {
            ...
            }(), "undefined" != typeof window && Nt() && (Ut(), window.addEventListener("resize", Ut)), f(document.body.children).forEach(function(t) {
                t === R() || function(t, e) {
    ...
    var ie, re = Object.freeze({
        ...
        _main: function(t) {
            var h = this;
            ! function(t) {
                for (var e in t) Vt(i = e) || m('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Mt.indexOf(o) && m('The parameter "'.concat(o, '" is incompatible with toasts'))), jt(n = void 0) && k(n, jt(n));
                var n, o, i
            }(t);
            var v = a({}, Et, t);
            ! function(e) {
            ...
            return new Promise(function(t) {
                ...
                if (b.closeButton.onclick = function() {
                    ...
                    }, v.toast) b.popup.onclick = function() {
                ...
                var a, c, l, d, p, f, m, g = function(t, e) {
                    for (var n = et(v.focusCancel), o = 0; o < n.length; o++) return (t += e) === n.length ? t = 0 : -1 === t && (t = n.length - 1), n[t].focus();
                    b.popup.focus()
                };
                Pt.keydownHandlerAdded && (Pt.keydownTarget.removeEventListener("keydown", Pt.keydownHandler, {
                    ...
                    return function(t, e) {
                        if (e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing)
                            ...
                            } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === b.confirmButton && H(b.cancelButton) ? b.cancelButton.focus() : document.activeElement === b.cancelButton && H(b.confirmButton) && b.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== B(e.allowEscapeKey) || (t.preventDefault(), s(y.DismissReason.esc));
                    ...
                    capture: Pt.keydownListenerCapture
                }), Pt.keydownHandlerAdded = !0), h.enableButtons(), h.hideLoading(), h.resetValidationMessage(), v.toast && (v.input || v.footer || v.showCloseButton) ? O(document.body, S["toast-column"]) : T(document.body, S["toast-column"]), "select" === v.input || "radio" === v.input ? (d = h, p = v, f = K(), m = function(t) {
                    return ne[p.input](f, oe(t), p)
                }, x(p.inputOptions) ? (At(), p.inputOptions.then(function(t) {
                    d.hideLoading(), m(t)
                })) : "object" === w(p.inputOptions) ? m(p.inputOptions) : C("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(w(p.inputOptions)))) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(v.input) && x(v.inputValue) && (c = v, l = (a = h).getInput(), q(l), c.inputValue.then(function(t) {
                    l.value = "number" === c.input ? parseFloat(t) || 0 : t + "", j(l), l.focus(), a.hideLoading()
                }).catch(function(t) {
                    C("Error in inputValue promise: " + t), l.value = "", j(l), l.focus(), ee.hideLoading()
                })), te(v), v.toast || (B(v.allowEnterKey) ? v.focusCancel && H(b.cancelButton) ? b.cancelButton.focus() : v.focusConfirm && H(b.confirmButton) ? b.confirmButton.focus() : g(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), b.container.scrollTop = 0
            })
        },
        update: function(e) {
            var n = {};
    ...
    function ae() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && C("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), ie = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
