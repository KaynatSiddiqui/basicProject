...
function gotodirectstage3(elem){
	...
	'<p style="color:black">Firstly let me give you some questions to refresh your chapter knowledge.</p>'+
...
//console.log( data);
			...
			if(jsondata!=null){
				...
				if(popup == "popup"){
					...
					{
            		if(jsondata.topicList!=null){     //newly added 07/12/2020 if line
						$('#chap_name_popup').html(cidname[1]);
						 $('#chapterint').empty();
							var message = '<h5>Hi '+sname+', what are you in this chapter?</h4>'+
							 ...
							 $('#chapterint').html(message);
							 $(".examcheckstatus").modal('show');
					}else{                               //newly added 07/12/2020 else block
						$('#chap_name_popup').html(cidname[1]);
						 $('#chapterint').empty();
					...
					if(stage_btn != "" && stage_btn != null && stage_btn != undefined){
						if(stage_btn == "stage-2"){
					      ...
					      if(jsondata.startIndex>0)
					    	  ...
					    	  for( var show =0; show <= currenttopicno-1; show++){
					    		  showaccuracy.push(Number(jsondata.topicsList[show].studentAccuracy));
					    	  }
							  ...
							  if(jsondata.currentCIStatus == "S3R1" || jsondata.currentCIStatus == "S3R2" || jsondata.currentCIStatus == "S3R3" || jsondata.currentCIStatus == "S3R4"){
								  if ((jsondata.startIndex) % 2 != 0 && jsondata.firsttime == true) {
							...
							$("#clsebtn").remove();
							 $(".examcheckstatus").modal({backdrop: 'static', keyboard: false});  
								...
								$('.timer').countimer('stop');
												}else if(jsondata.firsttime == false){
													if((jsondata.startIndex) % 2 != 0){  //checking start index is odd
														var color = "#A349A4";			
														var sname = LoginData.name;
														var Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robotrans.gif"  height="200px;">';
															var Aimessage = '<p>Hi '+sname+'!</p>'+
												  ...
												  Aimessage +='<button class="btn btn-success" style="margin-top:20px;color:#fff;"  class="close" data-dismiss="modal" >okay</button>';
															...
															$("#clsebtn").remove();
															 $(".examcheckstatus").modal({backdrop: 'static', keyboard: false});  
																 $(".examcheckstatus").modal('show');	
																	if(jsondata.topicsList[currenttopicno].parameterStatus == "Achieved"){
																		 currenttopicno++;	
																	}else{
																		
																	}
													}else if((jsondata.startIndex) % 2 == 0){ //checking start index is even
														if(jsondata.topicsList[currenttopicno].parameterStatus == "Achieved"){
															var color = "#A349A4";			
															var sname = LoginData.name;
															var Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robotrans.gif"  height="200px;">';
				...
				var actualCorrectAns=	jsondata.topicsList[currenttopicno].questionsList[currentquestionno].answer;
					...
					// if user wrote wrong check is this question consecutively wrong
					 ...
					 var total_topic_attempted = noofcorrectintopic+noofwrongintopic;
						...
						{
							 jsondata.topicsList[currenttopicno].parameterStatus="practiced";
						}
			},
			error:function(){
...
function onNextBtnClick(){ //stage 1 and stage 2 next button method
	...
	if(total_topic_attempted == noOfQuesShowinTopic || currentquestionno+1 == jsondata.topicsList[currenttopicno].maxShowNoQuestions || currentquestionno+1 == jsondata.topicsList[currenttopicno].questionsList.length)
	{
		...
		{	
		showaccuracy.push(Number(((noofcorrectintopic/total_topic_attempted)*100).toFixed(2)));
		jsondata.topicsList[currenttopicno].studentAccuracy= Number(((noofcorrectintopic/total_topic_attempted)*100).toFixed(2));
		
		//showaccuracy.push(Number(((noofcorrectintopic/total_attempted)*100).toFixed(2)));
		//jsondata.topicsList[currenttopicno].studentAccuracy= Number(((noofcorrectintopic/total_attempted)*100).toFixed(2));
		
		}else{
			
			showaccuracy.push(Number(((noofcorrectintopic/total_topic_attempted)*100).toFixed(2)));
			// showaccuracy.push(Number(((noofcorrectintopic/total_attempted)*100).toFixed(2)));
			if(jsondata.currentCIStatus == "learner" || jsondata.currentCIStatus == "expert"){
				jsondata.topicsList[currenttopicno].studentAccuracy= Number(((noofcorrectintopic/total_topic_attempted)*100).toFixed(2));
				//jsondata.topicsList[currenttopicno].studentAccuracy= Number(((noofcorrectintopic/total_attempted)*100).toFixed(2));
 ...
 switch(popupcase){
   ...
   '<p>Please refer Approach of the Question and try to answer.</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-28.aac");
			break;
		case '2':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>Think! try to answer.</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-29.aac");
			break;
		case '3':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
...
'<p>Refer concepts & basics of the chapter try to answer.</p>'+
 '<p>Put your maximum effort.</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-30.aac");
		break;
		case '4':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>Accuracy is most important.</p>'+
    ...
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-32.aac");
		break;
		case '5':
		color = "#6fd697";
   ...
   '<p>Keep it up!</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/VC5.aac");
		break;
		case '6':
		color = "#6fd697";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_green.gif"  height="200px;">';
   ...
   '<p>Rocking!</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/VC6.aac");
		break;
		case '7':
		color = "#fde17d";
   ...
   '<p>Please refer Approach of the Question and try to answer.</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/VC7.aac");
		break;
		case '8':
		color = "#fde17d";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_yellow.gif"  height="200px;">';
   ...
   '<p>You are not attempting questions.</p>'+
    ...
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-11.aac");
		break;
		case '9':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>try to answer. Dont give up <i class="fa fa-thumbs-up" aria-hidden="true"></i></p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-19.aac");
		break;
		case '10':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>try to answer. Dont give up <i class="fa fa-thumbs-up" aria-hidden="true"></i></p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-20.aac");
		break;
		case '11':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>Keep it up!</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-21.aac");
		break;
		case '13':
		color = "#fde17d";
			Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_yellow.gif"  height="200px;">';
   ...
   '<p>You are not at all trying to answer.</p>'+
    ...
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Lets go</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-24.aac");
		break;
		case '15':
		color = "#6fd697";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_green.gif"  height="200px;">';
   ...
   '<p>'+num+' Correct Out of 5 Questions</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Go Ahead</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-16.aac");
		break;
		case '16':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>Try to mark correct answers</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal" >okay got it</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-13.aac");
		break;
		case '17':
		color = "#ef698e";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_pink.gif"  height="200px;">';
   ...
   '<p>Acccuracy is important</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">okay got it</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-17.aac");
		break;
		case '18':
		color = "#6fd697";
		Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_green.gif"  height="200px;">';
   ...
   '<p>Try to  mark correct answer.</p>'+
    '<button class="btn btn-success" style="margin-top:20px;color:#fff;" class="close" data-dismiss="modal">Okay Got it</button>';
			play("https://skygetaudio.s3.ap-south-1.amazonaws.com/Audio241121-26.aac");
		break;
		case '21':
			color = "#fde17d";
			Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robot_yellow.gif"  height="200px;">';
	...
	if(jsondata.currentCIStatus=="S3R5" || jsondata.currentCIStatus=="S3R6"){
	 ...
	 if(jsondata.currentCIStatus=="S3R1" ||jsondata.currentCIStatus=="S3R2"||jsondata.currentCIStatus=="S3R3"){
    	...
    	for(var noofTopic=0;noofTopic <topicdatalength; ++noofTopic)
		{
    		...
    		avgAccuracys.push(parseFloat(jsondata.topicsList[noofTopic].studentAccuracy));
    		curenavgacuracy.push(parseFloat(jsondata.topicsList[noofTopic].studentAccuracy));
	   ...
	   var fetchtime = $(".get_questions_timer").text();
	    ...
	    ////for pause
	    if(type=="pause"){
			if(jsondata.currentCIStatus == "S2R1" || jsondata.currentCIStatus == "S2R2" || jsondata.currentCIStatus == "S2R3"){
			...
			var paramlengthboth = jsondata.topicsList[currenttopicno].questionsList.length
			 if(currenttopicno >0){
				 if(checkwrotepause1 == paramlengthboth){
			...
			else if(jsondata.currentCIStatus == "S3R1" || jsondata.currentCIStatus == "S3R2" || jsondata.currentCIStatus == "S3R3" || jsondata.currentCIStatus == "S3R4"){
...
function showPopup(popupcase,stage_button){
 ...
 var LoginData = getLoginData();
	...
	if(jsondata.previousCIStatus == "S3R1" || jsondata.previousCIStatus == "S3R2" || jsondata.previousCIStatus == "S3R3" || jsondata.previousCIStatus == "S3R4" || jsondata.previousCIStatus == "S3R5" || jsondata.previousCIStatus == "S3R6"  ){
   ...
   '<p style="color:black">'+accuracy+'%</p>'+
    '<p style="color:black">Avg. time spent per Qns: '+timespentonavgans+'min</p>'+
...
case 7:
	...
	if(accuracy >= 60){
		...
		Aimessage += '<p style="color:black">'+accuracy+'</p>';
...
function get_param_list(disable){
	...
	if(topicsList.length >= currenttopicno){
		...
		if(disable == "disable" && clsebtn == false){
			 ...
			 if(showaccuracy[currenttopicno] != undefined){
				 appenddata+='<p style="color:green">Accuracy-'+showaccuracy[currenttopicno]+'%</p>'; 
			 }else {
				 appenddata+='<p style="color:green">Accuracy-'+topicsList[currenttopicno].studentAccuracy+'%</p>';
			 }
   ...
   '<p class="parampopupp">'+topicsList[param_name].topicName+'</p>'+
	 ...
	 if(topicsList[param_name].noOfAttemptedquestions >0  || topicsList[param_name].notAnsweredCount > 0 || topicsList[param_name].notVisitedCount >0){
		 ...
		 }else if(topicsList[param_name].parameterStatus == "practiced"){
			 appenddata+=  '<span style="color:green;font-weight:bold">Practiced</span>';
			  //appenddata+=  '<span style="float: right;color:blue;font-weight:bold;"  data-param="'+topicsList[param_name].topicID+'" data-chapter="'+jsondata.chapterId+'_'+jsondata.chapterName+'"  data-subid="'+jsondata.subjectId+'_'+jsondata.subjectName+'" onclick="getmorepractice(this);" ><i class="fa fa-pencil" aria-hidden="true" style="color:blue"></i>More practice Qns</span>';
...
function checkifthistopicwrote(){
	...
	if(jsondata.currentCIStatus=="S3R1" ||jsondata.currentCIStatus=="S3R2"||jsondata.currentCIStatus=="S3R3"||jsondata.currentCIStatus=="S3R4"){
		...
		for(var param_name=0; param_name<topiclength; param_name++){
		   if(topicsList[param_name].noOfAttemptedquestions == 0  &&  topicsList[param_name].notAnsweredCount ==  0 && topicsList[param_name].notVisitedCount == 0){
			  if((topicsList[param_name].studentAccuracy > 0 && topicsList[param_name].parameterStatus == "Achieved") || (topicsList[param_name].studentAccuracy > 0 && topicsList[param_name].parameterStatus == "practiced")){
...
function Showsessiononeresult(firstshow){
   ...
   '<p style="color:black">Correct Qns: '+jsondata.topicsList[currenttopicno].noOfAttemptedquestions+'</p>'+
   ...
   if(firstshow == 'first'){
	   ...
	   '<button class="btn btn-success" style="margin-top:20px;color:#fff;" onclick="gotosession2ofsame();">Lets go</button>&nbsp;';
	    	...
	    	Aimessage +='<p style="color:black">Successfully Completed Your Two sessions Will Go to another parameter.</p>'+
					   ...
					   '<p  class="parampopupp">'+topicsList[param_name].topicName+'</p>'+
						 ...
						 if(topicsList[param_name].noOfAttemptedquestions >0  || topicsList[param_name].notAnsweredCount > 0 || topicsList[param_name].notVisitedCount >0){
							 if(topicsList[param_name].studentAccuracy >= 60 &&  topicsList[param_name+1].studentAccuracy >= 60){
								 ...
								 else if(topicsList[param_name].parameterStatus == "practiced" || topicsList[param_name+1].parameterStatus == "practiced"){
									 appenddata+=  '<span style="color:green;font-weight:bold">Practiced</span>';
									  //appenddata+=  '<span style="float: right;color:blue;font-weight:bold;"  data-param="'+topicsList[param_name].topicID+'" data-chapter="'+jsondata.chapterId+'_'+jsondata.chapterName+'"  data-subid="'+jsondata.subjectId+'_'+jsondata.subjectName+'" onclick="getmorepractice(this);" ><i class="fa fa-pencil" aria-hidden="true" style="color:blue"></i>More practice Qns</span>';
								...
								$(".getnext").show();
								 appenddata+=  '<button class="drivenow" onclick="gotocurrentparamstage3(\''+currenttopicno+'\');" >Drive now</button>';  
							 }
								 }
 ...
 function gotocurrentparamstage3(current_param){
	...
	/*if(jsondata.topicsList[currenttopicno].studentAccuracy >=60){
	 ...
	 if(jsondata.chapApproachAvailable ==true){
	  ...
	  var LoginData = getLoginData();
	if((currenttopicno) % 2 != 0){ //checking currenttopicno is odd
		if(jsondata.topicsList[currenttopicno-1].parameterStatus == "Achieved"){
			var color = "#A349A4";			
			var sname = LoginData.name;
			var Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robotrans.gif"  height="200px;">';
				var Aimessage = '<p>Hi '+sname+'!</p>'+
	...
	}else if((currenttopicno) % 2 == 0){ //checking currenttopicno is even
		if(jsondata.topicsList[currenttopicno].parameterStatus == "Achieved"){
			var color = "#A349A4";			
			var sname = LoginData.name;
			var Aiimage = '<img src="'+base_url+'/assets/images/students/chaptertargetimg/Robotrans.gif"  height="200px;">';
